...
<form method="POST" id="form" onsubmit="return pagar()">
	...
	<fieldset>
		...
		<div id="cc" style="display:none">
			Qual a bandeira do seu Cartão de Crédito?<br>
			<div id="bandeiras"></div><br>
		</div>

		<div id="cardinfo" style="display:none">
			Parcelamento:<br>
			<select name="parcelamento" id="parcelamento"></select><br><br>
...
<script type="text/javascript" src="<?php echo BASE_URL; ?>assets/js/ckt.js"></script>